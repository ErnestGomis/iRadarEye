...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2023 a las 15:16:39
...
INSERT INTO `escaperooms` (`id_escape`, `empresa`, `sala`, `ubi`, `direc`, `genero`, `num_jugadores`, `tiempo`, `dificult`, `edadMin`, `nota`, `link`, `precio`, `contacto`) VALUES
(0, '', '', '', '', NULL, '', 0, '', '', 0, '', '', 0),
...
(2, 'Mayto Kingdom', 'a Cámara del Espiritu y e', 'Vitoria, Pais Vasco', 'Calle Barratxi 37A, Pabellon, 20, Vitoria-Gasteiz', 'Aventura-A', '2 - 5 jugadores', 80, 'Media', '8 años', 10, 'https://maytokingdom.es/la-camara-del-espiritu-y-el-tiempo/', '100 - 170€', 0),
...
(8, 'Mythos', 'Expedición Maldita', 'Murcia', 'Av. de la Libertad, 1', 'Aventura', '2 - 6 jugadores', 75, 'Media-Alta', '-', 10, 'https://mythosmurcia.es/', '60 - 96€', 0),
...
(12, 'Escape Barcelona', 'Tomb Hunter, la leyenda d', 'Santa Coloma de Gramanet, Barcelona', 'Carrer Baró 17', 'Aventura', '2 - 6 jugadores', 90, 'Media', '16 años', 9, 'https://www.escapebarcelona.com/tomb-hunter-la-leyenda-de-akasha.php', '100 - 120€', 0),
...
(15, 'Willy el tuerto', 'Willy el tuerto', 'Sabadell', 'Carrer Poeta Folguera 13', 'Aventura', '2 - 6 jugadores', 80, 'Media', '10 años', 9, 'https://willyeltuertoescaperoom.com/reservar/', '90 - 140€', 0),
...
(18, 'Dragonborn', 'El hijo del posadero', 'País Vasco, Vitoria', 'Calle, Pintor Jesus Apellaniz Kalea, 5, bajo, 01008 Vitoria-Gasteiz, Álava', 'Aventura', '2 - 6 jugadores', 90, 'Media', '10 años', 10, 'https://dragonbornvitoria.es/', '80 - 150€', 0),
...
(22, 'Katharsis', 'La hora de las bestias', 'Barcelona, Mataró', 'Av. Amèrica, 14, 08304 Mataró, Barcelona', 'Misterio', '2 - 7 jugadores', 80, 'Media', '12 años', 10, 'https://katharsisroomescape.es/', '78 - 154€', 0),
(23, 'Vortex', 'Apophis', 'Barcelona, Terrassa', 'Carrer Alexander Bell, 72, 08224 Terrassa, Barcelona', 'Ciencia Fi', '2 - 7 jugadores', 90, 'Media-Alta', '18 años', 10, 'https://vortexescape.com/', '66 - 126€', 0),
(24, 'Profana', 'Profana', 'Barcelona, Granollers', 'Carrer Jules Verne, 12, 08402, Granollers', 'Terror Mis', '2 - 6 jugadores', 90, 'Media', '14 años', 8, 'https://profanaescaperoom.com/', '70 - 150€', 0),
(25, 'Virus room escape', 'Tao', 'Barcelona, Calella', 'Carrer de Sant Jaume, 434, 08370, Calella', 'Investigac', '2 - 7 jugadores', 90, 'Media-Alta', '6 años', 9, 'https://virusroomescape.com/juegos/tao-japanese-massage-center/', '70 - 161€', 0),
...
(27, 'Synegro', 'Cazadores de brujas', 'Barcelona, Sant Boi', 'Carrer de Didac Priu, 40, 08830, Sant Boi de Llobregat', 'Aventura', '2 - 6 jugadores', 80, 'Media', '14 años', 8, 'http://www.synergoescaperoom.es/historia/index.html#calendario', '70 - 120€', 0),
...
(32, 'Conecta escape', 'Atrincherados', 'Barcelona, Cerdañola', 'Carrer de la Lluna, 46, 08290, Cerdanyola del Valles', 'Acción', '2 - 6 jugadores', 90, 'Media', '14 años', 8, 'https://www.elementsescaperoom.com/atrincherados/', '80 - 120€', 0),
...
(36, 'Secret Box', 'Cazafantasmas (the myster', 'Mataró, Barcelona', 'Mossen Jacint Verdaguer, 69, Mataró', 'Misterio', '3 - 5 jugadores', 60, 'Media', '10 años', 8, '*', '80 - 100€', 0),
...
(44, 'Final code escape rooms', 'Bermudas, el secreto jamá', 'Hospitalet del Llobregat, Barcelona', 'Carrer de Uva, 21, Hospitalet de Llobregat', 'Investigac', '2 - 6 jugadores', 90, 'Media', '10 años', 8, 'https://www.finalcodeescaperoom.com/services/bermudas-el-secreto-jamas-revelado/', '70 - 120€', 0),
...
(48, 'Castlemaniac', 'La hermandad de las sombr', 'Zaragoza, Aragón', 'Avenida Rio Ebro, 49, Cuarte de Huerva', 'Misterio', '2 - 6 jugadores', 60, 'Media', '12 años', 0, 'https://www.castlemaniac.es/', '90 - 150€', 0),
